...
fn test_chunked_decryption_format() {
  ...
  // 分别加密
  let encrypted1 = public_key
    .encrypt(&mut rng, Pkcs1v15Encrypt, chunk1.as_bytes())
    .unwrap();
  let encrypted2 = public_key
    .encrypt(&mut rng, Pkcs1v15Encrypt, chunk2.as_bytes())
    .unwrap();
